...
const translations = {
  en: {
    ...
    "packages.kicker": "How to sell it",
    "packages.title": "Start free, then move the right supply into paid workflows.",
    "packages.body":
      "The public page should make the revenue path obvious: creators get a starter room, brands get campaign control, and merchants get feed sync plus reporting.",
    "packages.creator.tag": "Creator Pro",
    "packages.creator.title": "Self-serve personas and analytics.",
    "packages.creator.body": "For independent creators who want more personas, more links, custom domains, and clearer intent signals.",
    "packages.creator.hint": "Good first paid upgrade.",
    "packages.brand.tag": "Brand Campaign Kit",
    "packages.brand.title": "Official personas with disclosure control.",
    "packages.brand.body": "For campaign teams that need explicit brand identity, competitor rules, and reporting on what the agent recommended.",
    "packages.brand.hint": "Mid-ticket B2B wedge.",
    "packages.merchant.tag": "Merchant Feed Sync",
    "packages.merchant.title": "Catalog import and conversion reporting.",
    "packages.merchant.body": "For stores that want structured product feeds, batch registration, and account-level analytics.",
    "packages.merchant.hint": "Best for larger catalogs.",
  ...
  ko: {
    ...
    "packages.kicker": "판매 경로",
    "packages.title": "무료로 시작하고, 맞는 공급은 유료 워크플로로 옮기세요.",
    "packages.body":
      "공개 페이지는 수익 경로를 분명히 보여줘야 합니다. 크리에이터는 시작용 공간, 브랜드는 캠페인 통제, 머천트는 피드 동기화와 리포트를 얻습니다.",
    "packages.creator.tag": "크리에이터 Pro",
    "packages.creator.title": "셀프서브 페르소나와 분석.",
    "packages.creator.body": "더 많은 페르소나, 더 많은 링크, 커스텀 도메인, 그리고 더 선명한 의도 신호가 필요한 독립 크리에이터용입니다.",
    "packages.creator.hint": "가장 자연스러운 첫 유료 업그레이드.",
    "packages.brand.tag": "브랜드 캠페인 키트",
    "packages.brand.title": "고지 통제가 가능한 공식 페르소나.",
    "packages.brand.body": "브랜드 아이덴티티, 경쟁 상품 규칙, 그리고 에이전트가 무엇을 추천했는지에 대한 리포트가 필요한 캠페인 팀용입니다.",
    "packages.brand.hint": "중간 티켓 B2B 진입점.",
    "packages.merchant.tag": "머천트 피드 동기화",
    "packages.merchant.title": "카탈로그 가져오기와 전환 리포트.",
    "packages.merchant.body": "구조화된 상품 피드, 일괄 등록, 계정 단위 분석이 필요한 스토어용입니다.",
    "packages.merchant.hint": "카탈로그가 큰 경우에 적합합니다.",
  ...
  zh: {
    ...
    "packages.kicker": "怎么卖",
    "packages.title": "先免费开始，再把合适的供给放进付费流程里。",
    "packages.body":
      "公开页面应该把收入路径讲清楚：创作者有入门空间，品牌有活动控制权，商家有供给同步和报告。",
    "packages.creator.tag": "创作者 Pro",
    "packages.creator.title": "自助式人设和分析。",
    "packages.creator.body": "适合想要更多人设、更多链接、自定义域名和更清晰意图信号的独立创作者。",
    "packages.creator.hint": "很自然的首个付费升级。",
    "packages.brand.tag": "品牌活动套件",
    "packages.brand.title": "可控制披露的官方人设。",
    "packages.brand.body": "适合需要明确品牌身份、竞品规则和智能体推荐报告的活动团队。",
    "packages.brand.hint": "中客单价的 B2B 切入点。",
    "packages.merchant.tag": "商家供给同步",
    "packages.merchant.title": "目录导入和转化报告。",
    "packages.merchant.body": "适合需要结构化商品供给、批量注册和账号级分析的店铺。",
    "packages.merchant.hint": "适合更大的商品目录。",
  ...
  ja: {
    ...
    "packages.kicker": "どう売るか",
    "packages.title": "まずは無料で始めて、適した供給を有料ワークフローへ。",
    "packages.body":
      "公開ページでは収益の流れを明確に見せるべきです。クリエイターにはスターター空間、ブランドにはキャンペーン制御、マーチャントにはフィード同期とレポートを提供します。",
    "packages.creator.tag": "Creator Pro",
    "packages.creator.title": "セルフサーブのペルソナと分析。",
    "packages.creator.body": "より多くのペルソナ、より多くのリンク、カスタムドメイン、より明確な意図シグナルを求める独立クリエイター向けです。",
    "packages.creator.hint": "最初の有料アップグレードに最適です。",
    "packages.brand.tag": "Brand Campaign Kit",
    "packages.brand.title": "開示を制御できる公式ペルソナ。",
    "packages.brand.body": "ブランド ID、競合ルール、そしてエージェントが何を推薦したかのレポートを必要とするキャンペーンチーム向けです。",
    "packages.brand.hint": "中価格帯の B2B の入口です。",
    "packages.merchant.tag": "Merchant Feed Sync",
    "packages.merchant.title": "カタログ取り込みと転換レポート。",
    "packages.merchant.body": "構造化された商品フィード、一括登録、アカウント単位の分析が必要なストア向けです。",
    "packages.merchant.hint": "大きめのカタログに向いています。",
